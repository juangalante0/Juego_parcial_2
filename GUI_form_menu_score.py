...
class FormMenuScore(Form):
    def __init__(self, screen, x, y, w, h, color_background, color_border, active, path_image, scoreboard, margen_y,margen_x, espacio):
        ...
        self.lista_widgets.append(
            Label(screen=self._slave, x=margen_x+10,y=20,w=w/2-margen_x-10,h=50,text = "Jugador", font="Verdana",font_size=30,font_color=(255,255,255),path_image=r"Imagenes\Recursos\bar.png"))
        self.lista_widgets.append(
            Label(screen=self._slave,
                ...
                path_image=r"Imagenes\Recursos\bar.png"))
        ...
        for j in self._score:
            ...
            for n,s in j.items():
                ...
                pos = Label(screen=self._slave, x=pos_inicial_x,y=pos_inicial_y,
                            ...
                            font_color=(255,255,255),path_image=r"Imagenes\todas las imagenes\fondo_parte_tabla.png")
        ...
        #Crear boton home
        self.boton_home = Button_Image(screen= self._slave, master_x= x, master_y= y, x = w - 70,y = h - 70, w = 50, h = 50, path_image= r"Imagenes\Recursos\home.png", onclick=self.btn_home_click, onclick_param= "" )
